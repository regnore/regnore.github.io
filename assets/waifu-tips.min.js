...
function showMessage(a, c, e) {
  ;(e ||
    ...
    null === sessionStorage.getItem('waifu-text')) &&
    live2d_settings.showMessage &&
    (Array.isArray(a) && (a = a[Math.floor(Math.random() * a.length + 1) - 1]),
    live2d_settings.showF12Message &&
      console.log('[Message]', a.replace(/<[^<>]+>/g, '')),
...
function initModel(a, c) {
  ...
  console.log(' ')
  'function' != typeof $.ajax &&
    ('function' == typeof jQuery.ajax
      ? (window.$ = jQuery)
  ...
  'left' == live2d_settings.waifuEdgeSide[0]
    ? $('.waifu').css('left', live2d_settings.waifuEdgeSide[1] + 'px')
    : 'right' == live2d_settings.waifuEdgeSide[0] &&
  ...
  'disable' != live2d_settings.waifuMinWidth &&
    (waifuResize(),
    $(window).resize(function() {
      waifuResize()
    }))
  try {
    'axis-x' == live2d_settings.waifuDraggable
      ? $('.waifu').draggable({
          axis: 'x',
          revert: live2d_settings.waifuDraggableRevert
        })
      : 'unlimited' == live2d_settings.waifuDraggable
  ...
  'auto' == live2d_settings.homePageUrl
    ...
    : $.ajax({
        ...
        url:
          '' == a
            ...
            : 'waifu-tips.json' == a.substr(a.length - 15)
            ? a
            : a + 'waifu-tips.json',
        dataType: 'json',
        success: function(a) {
  ...
  ;(live2d_settings.modelStorage && null != a) ||
    ((a = live2d_settings.modelId), (c = live2d_settings.modelTexturesId))
  loadModel(a, c)
}
function loadModel(a) {
  var c = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : 0
  live2d_settings.modelStorage
    ? (localStorage.setItem('modelId', a),
      localStorage.setItem('modelTexturesId', c))
    : (sessionStorage.setItem('modelId', a),
      sessionStorage.setItem('modelTexturesId', c))
  loadlive2d(
    'live2d',
    live2d_settings.modelAPI + 'get/?id=' + a + '-' + c,
...
function loadTipsMessage(a) {
  ...
  function e() {
    ...
    $.ajax({
      ...
      dataType: 'json',
      success: function(l) {
        1 != l.textures.id || (1 != b && 0 != b)
          ? showMessage(f.load_rand_textures[1], 3e3, !0)
          : showMessage(f.load_rand_textures[0], 3e3, !0)
      ...
      case 'lwl12.com':
        $.getJSON('https://api.lwl12.com/hitokoto/v1?encode=realjson', function(
          ...
          if (!empty(a.source)) {
            ...
            b = b.render({ source: a.source, creator: a.author })
            window.setTimeout(function() {
        ...
        $.getJSON(
          ...
          function(a) {
            if (!empty(a.source)) {
              ...
              b = b.render({ source: a.source, date: a.date })
              window.setTimeout(function() {
                showMessage(b, 3e3, !0)
              }, 5e3)
      ...
      default:
        $.getJSON('https://v1.hitokoto.cn', function(a) {
          if (!empty(a.from)) {
            ...
            b = b.render({ source: a.from, creator: a.creator })
            window.setTimeout(function() {
              showMessage(b, 3e3, !0)
            }, 5e3)
          }
  ...
  $.each(a.seasons, function(a, b) {
    ...
    var d = b.date.split('-')[0],
      c = b.date.split('-')[1] || d
    d.split('/')[0] <= a.getMonth() + 1 &&
      a.getMonth() + 1 <= c.split('/')[0] &&
      d.split('/')[1] <= a.getDate() &&
      a.getDate() <= c.split('/')[1] &&
      ((b = getRandText(b.text)),
      (b = b.render({ year: a.getFullYear() })),
      showMessage(b, 6e3, !0))
  })
  ...
  window.showWelcomeMessage = function(a) {
    if (window.location.href == live2d_settings.homePageUrl) {
      ...
      b = getRandText(
        23 < b || 5 >= b
          ? a.waifu.hour_tips.t23 - 5
          : 5 < b && 7 >= b
          ? a.waifu.hour_tips.t5 - 7
          : 7 < b && 11 >= b
          ? a.waifu.hour_tips.t7 - 11
          : 11 < b && 14 >= b
          ? a.waifu.hour_tips.t11 - 14
          : 14 < b && 17 >= b
          ? a.waifu.hour_tips.t14 - 17
          : 17 < b && 19 >= b
          ? a.waifu.hour_tips.t17 - 19
          : 19 < b && 21 >= b
          ? a.waifu.hour_tips.t19 - 21
          : 21 < b && 23 >= b
          ? a.waifu.hour_tips.t21 - 23
          : a.waifu.hour_tips.default
      )
    } else {
      ...
      if ('' !== document.referrer) {
        ...
        window.location.hostname == c.hostname
          ? (b =
              d.localhost[0] +
              document.title.split(d.localhost[2])[0] +
              d.localhost[1])
          : 'baidu' == e
          ? (b =
              d.baidu[0] + c.search.split('&wd=')[1].split('&')[0] + d.baidu[1])
          : 'so' == e
          ? (b = d.so[0] + c.search.split('&q=')[1].split('&')[0] + d.so[1])
          : 'google' == e
          ? (b =
              d.google[0] + document.title.split(d.google[2])[0] + d.google[1])
          : ($.each(a.waifu.referrer_hostname, function(a, b) {
